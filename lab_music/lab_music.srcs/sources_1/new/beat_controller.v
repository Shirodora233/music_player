...
module beat_controller #(
    ...
    wire [63:0] ticks_per_unit_wide = (64'd10 * CLK_FREQ_HZ) / bpm_safe;
    ...
    assign beat_pulse = unit_pulse && (beat_phase == 3'd5);
